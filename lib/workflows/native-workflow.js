...
import {
  dcapiAuthorizationRequestMiddleware as dcapiRequestMiddleware,
  dcapiAuthorizationResponseMiddleware as dcapiResponseMiddleware
} from '../dcapi.js';
...
export class NativeWorkflowService extends BaseWorkflowService {
   ...
   * Delegates to dcapi module
   */
  async dcapiAuthorizationRequestMiddleware(req, res, next) {
    return dcapiRequestMiddleware(req, res, next);
  }
   ...
   * Delegates to dcapi module
   */
  async dcapiAuthorizationResponseMiddleware(req, res, next) {
    return dcapiResponseMiddleware(req, res, next);
  }
}

...
// TODO(dead-code-cleanup): This file is the pre-split monolithic 18013-7
// handler. It has been superseded by per-profile handlers under
// `./profiles/native-18013-7-annex-{b,c,d}.js` and is not imported by
// any production or test code. Slated for deletion in a separate
// cleanup; not removed here to keep the OID4VP 1.0 upgrade plan's diff
// narrowly focused.
...
import {
  getDcqlQuery, OID4VP_AUTHZ_REQ_JWT_TYP
...
export async function handleNative18013AnnexDRequest({
  ...
  // (See file-level TODO(dead-code-cleanup); this branch is no longer

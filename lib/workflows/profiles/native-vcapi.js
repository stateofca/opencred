...
export const getVerifiablePresentationRequest = async ({
  ...
  // Add DID authentication query
  // Note: This may in the future be unnecessary, but it seems required at the
  // moment in order for some wallets to include a 'holder' and 'proof'.
  queries.push({

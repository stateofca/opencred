 ...
 * @returns {Object} Object containing profile and responseMode
 */
export function identifyProfile({
  ...
  // Step 2: Handle 18013-7-Annex-D profile refinement
  ...
  if(resolvedProfile === '18013-7-Annex-B') {
    ...
    // Default to dc_api for Annex-D, but allow override
    responseMode = responseModeParam || 'dc_api';

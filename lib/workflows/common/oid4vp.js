...
export const getDcqlQuery = async ({workflow, profile}) => {
  ...
  // Otherwise, transform from query (query is required and
  // checked via config-utils)
    ...
    for(const format of formats) {
      if(format === 'mso_mdoc' && fields) {
        ...
        const credentialQuery = {
          ...
          format,
          meta: {
            // TODO: type_values may be an array of arrays of type strings
            // in 1.0. "REQUIRED. A non-empty array of string arrays."
            // See: https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#appendix-B.1.3.1.4
            // And: https://openid.net/specs/openid-4-verifiable-presentations-1_0.html#appendix-B.1.1

...
export class EntraVerifiedIdWorkflowService extends BaseWorkflowService {
  ...
  async verificationCallback(req, res) {
    ...
    presentationStartEvent.relyingParty = rp?.clientId ?? 'unknown';
    presentationSuccessEvent.relyingParty = rp?.clientId ?? 'unknown';
    presentationErrorEvent.relyingParty = rp?.clientId ?? 'unknown';

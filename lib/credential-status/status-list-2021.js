...
export const STATUS_LIST_2021_ENTRY_TYPE = 'StatusList2021Entry';
 ...
 */
export const checkStatusList2021 = async ({credential}) => {
...
export async function fetchStatusListJwt({url}) {
  ...
  const listJwt = typeof data?.statusList === 'string' ? data.statusList :

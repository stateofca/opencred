...
const routes = {
  ...
  auditPresentation: '/workflows/:workflowId/audit-presentation'
};
...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.get(routes.config, (req, res) => {
    const {
      defaultLanguage, translations, options, defaultBrand, translationsIcon
    } = bedrock.config.opencred;
    res.send({
      defaultLanguage, translations, options, brand: defaultBrand,
      translationsIcon
    });
  });
  app.use(
  ...
  /**
   * @openapi
   * /workflows/:workflowId/audit-presentation:
   *   post:
   ...
   *    responses:
   *      "200":
   *        description: Success report about the audit.
   *        content:
   *          application/json:
   *            schema:
   *              type: object
   ...
   *                type: string
   *      "400":
   *        description: Error report about a faulty audit request.
   *        content:
   *          application/json:
   *            schema:
   *              type: object
   ...
   *                type: string
   *      "501":
   *        description: Error report about unsupported audit feature.
   *        content:
   *          application/json:
   *            schema:
   *              type: object

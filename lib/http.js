...
const EXCHANGE_EVENT_HANDLERS = {
  dcapi_cancelled: ({clientId, exchangeId, profile, userAgent}) =>
    logUtils.presentationDcApiCancelled(
      {clientId, exchangeId, profile, userAgent}),
  dcapi_timeout: ({clientId, exchangeId, profile, timeoutMs, userAgent}) =>
    logUtils.presentationDcApiTimeout(
      {clientId, exchangeId, profile, timeoutMs, userAgent}),
  dcapi_error: ({clientId, exchangeId, profile, errorName, userAgent}) =>
...
export function exchangeEventMiddleware(req, res) {
  ...
  handler({...req.body, clientId, exchangeId, userAgent});

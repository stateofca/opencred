...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.get(routes.config, (req, res) => {
    let {translations} = bedrock.config.opencred;
    translations = combineTranslations(req.rp.translations ?? {}, translations);
    res.send({
      defaultLanguage: bedrock.config.opencred.defaultLanguage,
      translations,
      options: bedrock.config.opencred.options,
      brand: bedrock.config.opencred.defaultBrand,
      customTranslateScript: bedrock.config.opencred.customTranslateScript,
      auditFields: bedrock.config.opencred.auditFields
    });
  });

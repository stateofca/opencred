...
const routes = {
  ...
  // DC API Endpoints:
  dcapiAuthorizationRequest: '/workflows/:workflowId/exchanges/' +
    ':exchangeId/dcapi/request',
  dcapiAuthorizationResponse: '/workflows/:workflowId/exchanges/' +
    ':exchangeId/dcapi/response',
...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  const getOrCreateExchangeMiddleware = async (req, res, next) => {
    ...
    const workflowService = getWorkflowService({type: rp.type});
  ...
  */
  ...
  /* DC API Endpoints:
  - GET /workflows/:workflowId/exchanges/:exchangeId/dcapi/request
  - POST /workflows/:workflowId/exchanges/:exchangeId/dcapi/response
  */
  // GET /workflows/:workflowId/exchanges/:exchangeId/dcapi/request
  app.get(routes.dcapiAuthorizationRequest,
    attachClientByWorkflowId,
    baseWorkflowService.getExchangeMiddleware.bind(baseWorkflowService),
    getWorkflowService({type: 'native'}).
      dcapiAuthorizationRequestMiddleware.bind(
        getWorkflowService({type: 'native'}))
  );

  // POST /workflows/:workflowId/exchanges/:exchangeId/dcapi/response
  app.post(routes.dcapiAuthorizationResponse,
    attachClientByWorkflowId,
    baseWorkflowService.getExchangeMiddleware.bind(baseWorkflowService),
    getWorkflowService({type: 'native'}).
      dcapiAuthorizationResponseMiddleware.bind(
        getWorkflowService({type: 'native'}))
  );

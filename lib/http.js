...
//   from './workflows/microsoft-entra-verified-id.js';
// import NativeExchangeMiddleware from './workflows/native.js';
import {
...
// import VCAPIExchangeMiddleware from './workflows/vc-api.js';
...
bedrock.events.on('bedrock-express.configure.routes', app => {
  ...
  app.get(routes.config, (req, res) => {
    const {
      defaultLanguage, translations, options, defaultBrand,
      customTranslateScript, auditFields

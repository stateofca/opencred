...
import {presentationDcApiUnresolved} from './presentationDcApiUnresolved.js';
...
export const logUtils = {
  ...
  presentationStart: (clientId, exchangeId, profiles, userAgent,
    requestGroupId) =>
    emit(presentationStart,
      {clientId, exchangeId, profiles, userAgent, requestGroupId}),
  ...
  presentationResponseReceived: (
    clientId, exchangeId, userAgent, fields = {}) =>
    emit(presentationResponseReceived,
      {clientId, exchangeId, userAgent, ...fields}),
  presentationSuccess: (clientId, exchangeId, userAgent, profile,
    requestGroupId) =>
    emit(presentationSuccess,
      {clientId, exchangeId, profile, userAgent, requestGroupId}),
  presentationError: (clientId, exchangeId, error, userAgent, profile,
    requestGroupId, profiles) =>
    emit(presentationError, {clientId, exchangeId, error, profile, profiles,
      userAgent, requestGroupId}),
  ...
  presentationDcApiCancelled: (
    ...
    emit(presentationDcApiCancelled,
      {clientId, exchangeId, profile, profiles, requestGroupId, userAgent}),
  presentationDcApiUnresolved: (
    {clientId, exchangeId, protocol, candidateProfiles, requestGroupId, error,
      userAgent}) =>
    emit(presentationDcApiUnresolved,
      {clientId, exchangeId, protocol, candidateProfiles, requestGroupId,
        error, userAgent}),
